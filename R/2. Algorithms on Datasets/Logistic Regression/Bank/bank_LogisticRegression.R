...
#We see that the categorical Variables are defined as Character. 
#Lets convert it into the Categorical variable using Factor function
...
confusion_matrix <- table(y, pred >0.8)
confusion_matrix
