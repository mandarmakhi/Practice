...
#I am going to Extract the Reviews of "Apple iPhone X (64GB) - Space Grey" from amazon website
rurl <- "https://www.amazon.in/Apple-iPhone-Space-Grey-64GB/product-reviews/B072LPF91D/ref=cm_cr_arp_d_paging_btm_next_2?pageNumber=1"
...
gsad_items <- which(nrc_data$sadness > 0)
