...
wine <- read.csv("C:/Users/Mandar/Desktop/data/assignments/PCA/Win_PCA/wine.csv")
View(wine)
summary(wine)
...
plot(wine_pca$scores[,1:2], col = "red", pch = 19, cex = 1)
...
plot(wine_pca$scores[,2:3], col = "black", cex=1)
